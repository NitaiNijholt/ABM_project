...
constant_params = {
    'num_agents': [30],  
    'grid_width': [40],  # Changed to a range
    'grid_height': [40],  # Changed to a range'grid': [Grid(width=40, height=40)],
    'n_timesteps': [1000],
    'num_resources': [500],
    'stone_rate': [1],
    'wood_rate': [1],
...
simulator = MultipleRunSimulator(combined_params, num_runs=num_runs, save_directory='sensitivity_analysis_results/New_final_exp_ev_dynamic', do_feature_analysis='yes', evolve=evolve, dynamic_tax=dynamic_tax, dynamic_market=dynamic_market, plot_per_run=False)
