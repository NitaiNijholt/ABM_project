...
class Simulation:
    def __init__(self, num_agents, grid, n_timesteps=1, num_resources=0, wood_rate=1, stone_rate=1, 
                 ...
                 save_file_path=None, tax_period=9999, lifetime_distribution='gamma', income_per_timestep=1, 
                 show_time=False, dynamic_tax=True, dynamic_market=True):
        """
